...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-133422364-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-133422364-1');
</script>
...
<link href="<?php echo esc_url( get_template_directory_uri() ); ?>/css/wp-custom.css" rel="stylesheet" type="text/css">
