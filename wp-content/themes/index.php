...
<div class="container wow animated zoomIn">
  ...
  <div class="row">
    ...
    <h2>Mais de 50 anos de tradição</h2>
    ...
    <a href="<?php echo get_site_url(); ?>/escola/#section1" class="btn">Saiba mais</a>
  	...
  	<div class="col-sm-4 text-center">
    <h2>Cursos técnicos e livres</h2>
    ...
    <a href="<?php echo get_site_url(); ?>/cursos/" class="btn">Saiba mais</a>
  	...
  	<div class="col-sm-4 text-center">
    <h2>Cursos de teoria musical <small style="color: inherit !important">[novo]</small></h2>
    <p class="text-left">Novos cursos de 6 meses: Regência para Maestros de Igreja e Harmonização + Improvisação.</p>
...
<div class="container-fluid wow animated zoomIn">
  ...
  <div class="row">
    ...
    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-3"><a class="ico ico-orgao" href="<?php echo get_site_url(); ?>/cursos/#Orgao">Órgão</a></div>
    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-3"><a class="ico ico-teclado" href="<?php echo get_site_url(); ?>/cursos/#Teclado">Teclado</a></div>
    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-3"><a class="ico ico-acordeon" href="<?php echo get_site_url(); ?>/cursos/#Acordeon">Acordeão</a></div> 
    ...
    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-3"><a class="ico ico-baixo" href="<?php echo get_site_url(); ?>/cursos/#Baixo">Baixo</a></div>     
    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-3"><a class="ico ico-bateria" href="<?php echo get_site_url(); ?>/cursos/#Bateria">Bateria</a></div>         
    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-3"><a class="ico ico-violino" href="<?php echo get_site_url(); ?>/cursos/#Violino">Violino</a></div>
    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-3"><a class="ico ico-canto" href="<?php echo get_site_url(); ?>/cursos/#Canto">Canto</a></div>    
    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-3"><a class="ico ico-saxofone" href="<?php echo get_site_url(); ?>/cursos/#Saxofone">Saxofone</a></div>
    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-3"><a class="ico ico-flauta" href="<?php echo get_site_url(); ?>/cursos/#Flauta">Flauta transversal</a></div>
...
<div class="container wow animated zoomIn">
  ...
  ?>      
    ...
    {
        print '<p style="margin-top: 40px;" class="text-center">Em breve, novos eventos serão postados aqui!</p>';
    }	
     ?>		
